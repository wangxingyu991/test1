...
export default {
      ...
      created(){
            var _this  = this;
            if(_this.$route.params.notifyId != null && _this.$route.params.notifyId != undefined){
            _this.$api.get( this.$apis.home+"/rest/home/notice/getbyid/"+_this.$route.params.notifyId, {},
                  function (res) {
                        if (res.success) {
