    ...
    <div class="rh-page-header">
      <div class="rh-head-and-operate">
        <div class="tips-content">
          <span class="rh-helpTip-text">发票类型维护</span>
        </div>
      </div>
    </div>
    <div class="rh-page-content">
        ...
        <div class="rh-pull-right">
          <el-form :model="queryForm" ref="queryForm" :inline="false" label-width="0px" label-position="right">
            <el-form-item prop="fplxdm">
              <el-input v-model="queryForm.fplxdm" placeholder="输入发票类型代码" maxlength="5"></el-input>
            </el-form-item>
             <el-form-item prop="fplxmc">
              <el-input v-model="queryForm.fplxmc" placeholder="发票类型名称" maxlength="50"></el-input>
            </el-form-item>
      ...
      <div class="rh-table">
        <el-table :data="tableData.records" stripe border @selection-change="handleSelectionChange" v-loading="loadingInvoice">
          ...
          <el-table-column show-overflow-tooltip align="center" prop="fplxdm" label="发票类型代码"></el-table-column>
          <el-table-column show-overflow-tooltip align="left" prop="fplxmc" label="发票类型名称"></el-table-column>
          <el-table-column show-overflow-tooltip align="left" prop="fplxjc" label="发票类型简称"></el-table-column>
          <el-table-column show-overflow-tooltip align="center" prop="yxbz" label="有效标志" width="130px"></el-table-column>
          <!-- <el-table-column show-overflow-tooltip align="center" prop="zpbz" label="纸票标识" width="130px"></el-table-column> -->
          <el-table-column show-overflow-tooltip align="left" prop="bz" label="备注"></el-table-column>
           ...
           :before-close="handleCloseAdd">
                <div class="rh-dialog-body">
                        ...
                        <el-row>
                          <el-col :span="20">
                            <el-form-item label="发票类型代码" prop="fplxdm" >
                              <el-input v-model.trim="insertForm.fplxdm" placeholder="" maxlength="3"></el-input>
                            </el-form-item>
                          </el-col>
                          <!-- <el-col :span="12">
                            <el-form-item label="查验发票类型代码" prop="cyfplxdm">
                              <el-input v-model="insertForm.cyfplxdm" placeholder="" maxlength="3"></el-input>
                            </el-form-item>
                          </el-col> -->
                        </el-row>
                         <el-row>
                          ...
                          <el-form-item label="发票类型名称" prop="fplxmc">
                              <el-input v-model.trim="insertForm.fplxmc" placeholder="" maxlength="50"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                          ...
                          <el-form-item label="发票类型简称" prop="fplxjc">
                              <el-input v-model="insertForm.fplxjc" :precision="1"  placeholder="" maxlength="15"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                          ...
                          <!-- <el-col :span="12">
                             <el-form-item label="纸票标志" prop="zpbz">
                                <el-select v-model="insertForm.zpbz">
                                    <el-option label="纸票" value="Y"></el-option>
                                    <el-option label="电票" value="N"></el-option>
                                </el-select>
                            </el-form-item>
                          </el-col> -->
                        </el-row>
                         <el-row>
                          <el-col :span="20">
                           <el-form-item label="备注" prop="bz">
                              <el-input v-model="insertForm.bz" placeholder="" maxlength="100"></el-input>
                            </el-form-item>
                          </el-col>
                  ...
                  <div class="rh-dialog-footer" solt="footer">
                        <el-button @click="Fplxcanel('insertForm')">取消</el-button>
                ...
                <div class="rh-dialog-body">
                    <el-form :model="editForm" :rules="rules"  ref="editForm" label-width="115px" label-position="right">
                        <el-row>
                          <el-col :span="20">
                            <el-form-item label="发票类型代码" prop="fplxdm" >
                              <el-input v-model.trim="editForm.fplxdm" placeholder="" maxlength="3" :disabled="true"></el-input>
                            </el-form-item>
                          </el-col>
                          <!-- <el-col :span="12">
                            <el-form-item label="查验发票类型代码" prop="cyfplxdm">
                              <el-input v-model="editForm.cyfplxdm" placeholder="" maxlength="3"></el-input>
                            </el-form-item>
                          </el-col> -->
                        </el-row>
                         <el-row>
                          <el-col :span="20">
                          <el-form-item label="发票类型名称" prop="fplxmc">
                              <el-input v-model.trim="editForm.fplxmc" placeholder="" maxlength="50"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                          <el-col :span="20">
                          <el-form-item label="发票类型简称" prop="fplxjc">
                              <el-input v-model="editForm.fplxjc" :precision="1"  placeholder="" maxlength="15"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                          ...
                          <!-- <el-col :span="12">
                             <el-form-item label="纸票标志" prop="zpbz">
                                <el-select v-model="editForm.zpbz">
                                    <el-option label="纸票" value="Y"></el-option>
                                    <el-option label="电票" value="N"></el-option>
                                </el-select>
                            </el-form-item>
                         ...
                         <el-row>
                          <el-col :span="20">
                           <el-form-item label="备注" prop="bz">
                              <el-input v-model="editForm.bz" placeholder="" maxlength="100"></el-input>
                            </el-form-item>
                          </el-col>
                  ...
                  <div class="rh-dialog-footer" solt="footer">
                        <el-button @click="Fplxcanel('editForm')">取消</el-button>
...
export default {
  ...
  Eidtcus_submit(formName){
    ...
    init_Table() {
      ...
      this.$api.post(
        _this.$apis.icpmanagement+"/basic/invoicetype/listInvoiceType", params,
        function (res) {
          if (res.success==true) {
