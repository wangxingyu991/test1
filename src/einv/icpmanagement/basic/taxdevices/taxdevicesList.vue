<template>
  <div>
    <div class="rh-page-header">
      <div class="rh-head-and-operate">
        <div class="tips-content">
          <span class="rh-helpTip-text">税控设备类型维护</span>
        </div>
      </div>
    </div>
    <div class="rh-page-content">
        ...
        <div class="rh-pull-right">
          <el-form :model="queryForm" ref="queryForm" :inline="false" label-width="0px" label-position="right">
            <el-form-item prop="fwqlxdm">
              <el-input v-model="queryForm.fwqlxdm" placeholder="设备类型代码" maxlength="3"></el-input>
            </el-form-item>
             <el-form-item prop="fwqlxmc">
              <el-input v-model="queryForm.fwqlxmc" placeholder="设备类型名称" maxlength="15"></el-input>
            </el-form-item>
      ...
      <div class="rh-table">
        <el-table :data="tableData.records" stripe border @selection-change="handleSelectionChange" v-loading="loadingTaxdev">
            <template slot="empty">
          ...
          <el-table-column show-overflow-tooltip align="center" prop="fwqlxdm" label="设备类型代码"></el-table-column>
          <el-table-column show-overflow-tooltip align="left" prop="fwqlxmc" label="设备类型名称" ></el-table-column>
           ...
           :before-close="handleCloseAdd">
                <div class="rh-dialog-body">
                    <el-form :model="insertForm" :rules="rules"  ref="insertForm" label-width="115px" label-position="right">
                         <el-row>
                          <el-col :span="21">
                            <el-form-item label="设备类型代码" prop="fwqlxdm" >
                              <el-input v-model.trim="insertForm.fwqlxdm" placeholder="" maxlength="3"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                          <el-col :span="21">
                            <el-form-item label="设备类型名称" prop="fwqlxmc">
                              <el-input v-model.trim="insertForm.fwqlxmc" placeholder="" maxlength="30"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                        ...
                        <el-row>
                          <el-col :span="21">
                           <el-form-item label="备注" prop="bz">
                              <el-input v-model="insertForm.bz" placeholder="备注" maxlength="150"></el-input>
                            </el-form-item>
                          </el-col>
                  ...
                  <div class="rh-dialog-footer" solt="footer">
                        <el-button @click="taxDevicescanel('insertForm')">取消</el-button>
                ...
                <div class="rh-dialog-body">
                    <el-form :model="editForm" :rules="rules"  ref="editForm" label-width="115px" label-position="right">
                        <el-row>
                          <el-col :span="21">
                            <el-form-item label="设备类型代码" prop="fwqlxdm" >
                              <el-input v-model.trim="editForm.fwqlxdm" placeholder="" maxlength="3"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                          <el-col :span="21">
                            <el-form-item label="设备类型名称" prop="fwqlxmc">
                              <el-input v-model.trim="editForm.fwqlxmc" placeholder="" maxlength="30"></el-input>
                            </el-form-item>
                          </el-col>
                        </el-row>
                        <el-row>
                        ...
                        <el-row>
                          <el-col :span="21">
                           <el-form-item label="备注" prop="bz">
                              <el-input v-model="editForm.bz" placeholder="备注" maxlength="150"></el-input>
                            </el-form-item>
                          </el-col>
                  ...
                  <div class="rh-dialog-footer" solt="footer">
                        <el-button @click="taxDevicescanel('editForm')">取消</el-button>
...
export default {
  data() {
    return {
      ...
      rules: {
        fwqlxdm: [
          { required: true, message: "请输入服务器类型代码", trigger: "blur" },
          { max: 3, message: "最多3个字符", trigger: "blur" },
          { validator: this.$validate.checkForbiddenWord, trigger: "blur" },
         ],
         fwqlxmc: [
          { required: true, message: "请输入服务器类型名称", trigger: "blur" },
      ...
      _this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          ...
          _this.loading.loadingList=true;
              _this.$api.post(
                _this.$apis.icpmanagement+"/basic/taxdevices/saveTaxdevices/", insertParams,
                function (res) {
                if (res.success) {
                    _this.$message({
                     showClose:true,
  ...
  Eidtcus_submit(formName){
      ...
      _this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          ...
          _this.loading.loadingList=true;
              ...
              _this.$api.post(
                _this.$apis.icpmanagement+"/basic/taxdevices/updateTaxdevices/", EditParams,
                function (res) {
                if (res.success==true) {
                    _this.$message({
                     showClose:true,
    ...
    init_Table() {
      ...
      _this.loadingTaxdev=true;
      this.$api.post(
        _this.$apis.icpmanagement+"/basic/taxdevices/listTaxdevices", params,
        function (res) {
          if (res.success==true) {
        ...
        .then(() => {
          _this.$api.delete(
            _this.$apis.icpmanagement +
              "/basic/taxdevices/deleteTaxdevices/" +id, {},
            function (res) {
              if (res.success) {
                _this.searchForm();
                _this.$message({
    ...
    onEdit(scope) {
      ...
      this.editForm = {
        id:scope.row.id,
        fwqlxdm: scope.row.fwqlxdm,
        fwqlxmc: scope.row.fwqlxmc,
        yxbz: yxbz,
        bz: scope.row.bz,
      };
    },
    ...
    resetForm(formName) {
     ...
     this.queryForm.fwqlxdm="";
     this.queryForm.fwqlxmc="";
      this.queryForm.pageNo = 1;
      this.init_Table();
    },
  },
