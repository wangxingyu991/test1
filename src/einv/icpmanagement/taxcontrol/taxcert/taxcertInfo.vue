<template>
  <div class="drawer-wrap" v-loading="loading">
    <div class="rh-drawer-head">
      <div class="drawer-title">证书信息查看</div>
    </div>
    ...
    <div class="rh-dialog-footer">
      <!-- <el-button type="primary" @click="onUpdate('editForm')">更新</el-button> -->
...
export default {
  ...
  methods: {
    ...
    getTaxcertById() {
      ...
      _this.loading=true;
      _this.$api.get(
        _this.$apis.icpmanagement + "/taxcontrol/taxcert/getTaxcertById/" + _this.updatePageData.id, {},
        function (res) {
          _this.loading=false;
          if (res.success) {
