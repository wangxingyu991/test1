          ...
          <div class="rh-page-header">
              <div class="rh-head-and-operate">
                <div class="tips-content">
                    <span class="rh-helpTip-text">核定税率管理</span>
                </div>
              ...
              <el-table :data="tableData.records" stripe border @selection-change="handleSelectionChange"  v-loading="loading">
                ...
                <el-table-column align="center" label="操作"  width="90">
                  <template slot-scope="scope">
                    <el-button class="table_btn"  type="text" @click="querytaxrate(scope.row)">查看</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
...
import editPage from "./taxratequery.vue";
...
export default {
  ...
  methods: {
    ...
    init_Table() {
      ...
      _this.loading=true;
      this.$api.post(
        _this.$apis.icpmanagement + "/taxcontrol/taxrate/listtaxrate", params,
        function (res) {
          _this.loading=false;
          if (res.success) {
