...
<template>
  <div class="drawer-wrap xxfpmb">
      <div class="rh-drawer-head">
          <div class="drawer-title">新增发票模板</div>
      </div>
        ...
        <el-dialog 
           ...
           :before-close="handleCloseAdd">
                <div class="rh-dialog-body">
                      ...
                      <el-table :data="tableData" stripe border  @current-change="handleCurrentChange">
 ...
 export default {
    ...
    methods: {
      handleCurrentChange(row){
         ...
         this.radioInvoice = row.qzbh;
         this.add_Form.srcUrl=row.fileImg;
    ...
    chooseFpz(){
     let _this=this;
        let nsrsbh=_this.addPageData.nsrsbh;
        this.$api.post(
     ...
     //下拉省份选择
      ...
      previewInitImg(){ 
        ...
        $('#div_title').css({
          ...
          // let o=document.getElementById("div_perview");
          // let div_perview_h=o.offsetHeight;
          // let div_perview_w=o.offsetWidth;
          // console.log("div_perview_h="+div_perview_h);
          // console.log("div_perview_h="+div_perview_w);
          // _this.top=parseInt(parseInt(div_perview_h)-parseInt(_this.top)-parseInt(45))   
      },
     init_Fplx(){
      let _this = this;
       //查询到的发票类型放入到数组
      ...
      _this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
           if(qzbh==""){
              ...
              _this.$api.post(
                _this.$apis.icpmanagement + "/taxpayer/invoicetemplate/saveInvoicetemplate", para,
                function (res) {
                if (res.success) {
                    _this.$message({
                      showClose:true,
