...
<template>
  <div class="drawer-wrap xxfpmb">
      <div class="rh-drawer-head">
          <div class="drawer-title">查看发票模板</div>
      </div>
                              ...
                              <el-row>
                                <el-col :span ="8">
                                 <el-form-item label="票样名称" prop="pybh">
                                      <!-- <el-select v-model="add_Form.pybh" placeholder="请选择票样" @change="selectSf()" :disabled="true">
                                            <el-option 
                                         ...
                                         <el-input v-model="add_Form.pymc" placeholder="票样名称" maxlength="120" readonly="true"></el-input>    
                                  </el-form-item>
                               </el-col> 
                                <!-- <el-col :span ="8" >
