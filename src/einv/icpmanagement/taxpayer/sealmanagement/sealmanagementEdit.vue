...
<template>
  <div class="drawer-wrap">
      <div class="rh-drawer-head">
          <div class="drawer-title">修改纳税人印章</div>
      </div>
                              ...
                              <el-col :span ="10"  :offset="1">
                                <el-form-item label="绑定证书" prop="zsmc" >
                                            <el-input v-model="add_Form.zsmc" placeholder="绑定证书" @click.native="bdzs()" :readonly="true"></el-input> 
                                             <el-input v-model="add_Form.zsId" placeholder="zsid"  v-show="false"></el-input>     
                                </el-form-item>
                              </el-col> 
                              <el-col :span ="10" :offset="1" >
                               ...
                               <fieldset class="yzfiedset"> 
                                    ...
                                    <div class="upload">
                                     <el-upload
                                        ...
                                        <!-- <img
                                            class="el-upload-list__item-thumbnail"
                                            :src="'data:image/png;base64,'+file.url" alt=""> -->
                           ...
                           <div class="rh-pull-right">
                            <el-form :model="queryForm" ref="queryForm" :inline="false" label-width="0px" label-position="right">
                              ...
                              <el-form-item prop="zsNsrmc">
                                <el-input v-model.trim="queryForm.zsNsrmc" maxlength="20" placeholder="纳税人证书名称"></el-input>
                              </el-form-item>
 ...
 export default {
    ...
    handleNodeClick(data) {
      ...
      handleRemove(file) {
            ...
            let _this=this;
            if (list[0].url.indexOf(file.url)==0) {
                 _this.$message({
                    showClose: true,
                    message: "原图片不能移除",
                    type: "warning",
           ...
           if(file==undefined||file==""){
            ...
            //   }
               _this.loading.loadingList=true;
                _this.$api.post(
                _this.$apis.icpmanagement + "/taxpayer/sealmanagement/editSealInfo", para,
                function (res) {
              ...
              _this.$api.post(
                _this.$apis.icpmanagement + "/taxpayer/sealmanagement/editSealInfoAndImg", paraForm,
                function (res) {
