  ...
  methods: {
    ...
    init_Table() {
     ...
     let arr = ["group","by"];
      ...
      if (params != null) {
        if (validate.checkForbiddenWordFormIgnore(JSON.stringify(params),arr)) {
          _this.$message({
            showClose: true,
            message: "不允许有特殊字符",
            type: "error",
      ...
      _this.loading=true;
      this.$api.get(
        _this.$apis.icptask + "/rest/job/query", params,
        function (res) {
          //关闭loading
          _this.loading=false;
          if (res.success) {
    ...
    onDel(item) {
      ...
      // console.log(JSON.stringify(item));
      // console.log(JSON.stringify(_this.deleteForm));
      if (_this.deleteForm != null) {
        if (validate.checkForbiddenWordFormIgnore(JSON.stringify(_this.deleteForm),arr)) {
          _this.$message({
            showClose: true,
            message: "不允许有特殊字符",
            type: "error",
      ...
      _this
        ...
        .then(() => {
          _this.$api.post(
                _this.$apis.icptask + "/rest/job/deletejson/", _this.deleteForm,
            function (res) {
              if (res.success) {
                _this.searchForm();
                _this.$message({
    ...
    qdTask(item) {
      ...
      _this
        ...
        .then(() => {
          _this.$api.post(
                _this.$apis.icptask + "/rest/job/resumejson/", _this.deleteForm,
            function (res) {
              if (res.success) {
                _this.searchForm();
                _this.$message({
    ...
    ztTask(item) {
      ...
      _this
        ...
        .then(() => {
          _this.$api.post(
                _this.$apis.icptask + "/rest/job/pausejson/", _this.deleteForm,
            function (res) {
              if (res.success) {
                _this.searchForm();
                _this.$message({
