<template>
  <div>
    <div class="rh-page-header">
      <div class="rh-head-and-operate">
        <div class="tips-content">
          <span class="rh-helpTip-text"> 系统工单--财务审核 </span>
        </div>
      </div>
    </div>
    <div class="rh-page-content">
      <div class="tabs-wrap">
        ...
        <el-table :data="tableData.records" stripe border height="400" v-loading="loading">
          ...
          <!-- <el-table-column show-overflow-tooltip align="center" prop="paymentTime" label="支付时间" width="160"></el-table-column> -->
          <!-- <el-table-column v-if="activeName == '1'" show-overflow-tooltip align="center" prop="operateTime" label="审核时间"></el-table-column> -->
    ...
    <div class="dailog">
      ...
      <!-- 退款审核详情 -->
      <div class="drawer-container add" :key=1003>
        <el-drawer size="61.8%" :visible.sync="drawer2" append-to-body>
          <RefundReviewDetail v-if="drawer2" @back="back" :refundReviewDetailData="refundReviewDetailData"></RefundReviewDetail>
        </el-drawer>
      </div>
    </div>
  </div>
...
import RefundReviewDetail from "./refund/FinanceReviewDetail.vue";
import RefundReview from "./refund/FinanceReview.vue";
...
export default {
  ...
  methods: {
    ...
    init_Table() {
      ...
      _this.loading = true;
      this.$api.post(
        _this.$apis.manage + "/manage/order/financeReview/listOrder ",
        params,
        function (res) {
          if (res.success) {
    ...
    //审核详情
    reviewDetail(row) {
      if (row.orderStatus == "4" || row.orderStatus == "5" || row.orderStatus == "6") {
        this.drawer2 = true;
        this.refundReviewDetailData = row;
      } else {
        this.drawer1 = true;
