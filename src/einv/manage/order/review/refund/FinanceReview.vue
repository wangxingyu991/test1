...
export default {
  ...
  methods: {
    ...
    getAccount() {
      ...
      _this.$api.post(
        _this.$apis.manage + "/manage/order/financeReview/getAccount/" + orderId,
        {},
        function (res) {
          if (res.success) {
    ...
    confirm() {
      ...
      _this.$set(params, "payMethod", _this.refundReviewData.payMethod);
      _this.$set(params, "fileBase64", _this.fileBase64);
      _this.$set(params, "fileName", _this.fileName);
      _this.$api.post(
        _this.$apis.manage + "/manage/order/financeReview/refundFinanceReview",
        params,
        function (res) {
          if (res.success) {
            _this.$message({
