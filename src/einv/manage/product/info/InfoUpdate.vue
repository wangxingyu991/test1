<template>
  <div class="drawer-wrap">
    <div class="rh-drawer-head">
      <div class="drawer-title">修改产品信息</div>
    </div>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="产品名称" prop="productName">
                      <el-input v-model="form.productName" placeholder="产品名称" maxlength="100" disabled></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        systemFlag: [
          { required: true, message: "请输入系统标志", trigger: "blur" },
        ],
        categoryId: [
  ...
  methods: {
    ...
    getProductInfoById() {
      ...
      _this.$api.get(
        _this.$apis.manage +
        "/manage/product/info/getProductInfoById/" +
        ...
        function (res) {
          if (res.success) {
            ...
            _this.editor.txt.html(res.data.detailsWebContent);
            _this.operatorForm.title = res.data.detailsDescTitle;
          } else {
            _this.$message({
    ...
    updateSubmit(formName) {
      ...
      _this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          ...
          _this.$set(updateparams, "detailsWebContent", content);
          _this.$set(updateparams, "detailsDescTitle", _this.operatorForm.title);
          ...
          _this.$api.post(
            _this.$apis.manage +
            "/manage/product/info/updateProductInfo/" +
            _this.updatePageData.productId,
            updateparams,
            function (res) {
              if (res.success) {
