<template>
  <div class="drawer-wrap">
    <div class="rh-drawer-head">
      <div class="drawer-title">新增产品大类信息</div>
    </div>
    <div class="rh-drawer-body">
      <el-form :model="form" :rules="rules" ref="form" label-width="100px" label-position="right">
        <el-row>
          <el-col :span="12">
            <el-form-item label="产品大类名称" prop="mainAttrName">
              <el-input v-model="form.mainAttrName" placeholder="产品大类名称" maxlength="100"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="主属性标志" prop="isMain">
              <el-select v-model="form.isMain" placeholder="主属性标志" ref="mark" @change="checkHasSuperior">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="下级标志" prop="hasSuperior">
              <el-select v-model="form.hasSuperior" placeholder="下级标志" @change="checkHasSuperior">
                <el-option key="Y" label="是" value="Y"></el-option>
                <el-option key="N" label="否" value="N"></el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="多选标志" prop="isMultiple" v-if="form.hasSuperior=='Y'">
              <el-select v-model="form.isMultiple" placeholder="多选标志">
                <el-option key="Y" label="是" value="Y"></el-option>
                <el-option key="N" label="否" value="N"></el-option>
              </el-select>
            </el-form-item>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="计费规则" prop="feeScale">
              <el-select v-model="form.feeScale" placeholder="计费规则">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="附加项标志" prop="hasAddItem">
              <el-select v-model="form.hasAddItem" placeholder="附加项标志" @change="itemChange(form.hasAddItem)">
                <el-option key="N" label="否" value="N"></el-option>
                <el-option key="Y" label="是" value="Y"></el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="业务标志" prop="businessFlag">
              <el-select v-model="form.businessFlag" placeholder="业务标志">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="备注" prop="sparefield">
              <el-input type="textarea" v-model="form.sparefield" placeholder="备注" maxlength="200"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getSort() {
      let _this = this;
      _this.$api.get(
        _this.$apis.manage + "/manage/product/mainclass/getSort/" + _this.addPageData.productId,
        {},
        function (res) {
          if (res.success) {
    ...
    addSubmit(formName) {
      ...
      if (_this.isMain == "Y") {
        _this.$api.get(
          _this.$apis.manage + "/manage/product/mainclass/checkMain/" + _this.addPageData.productId,
          {},
          function (res) {
            if (res.success) {
              _this.$refs[formName].validate((valid) => {
                ...
                if (valid) {
                  ...
                  _this.loading = true;
                  _this.$api.post(
                    _this.$apis.manage + "/manage/product/mainclass/saveMainClass",
                    addparams,
                    function (res) {
                      if (res.success) {
                        _this.$message({
    ...
    checkHasSuperior() {
      if (this.form.hasSuperior == "N") {
        this.form.isMultiple = "N";
      }
      if (this.form.isMain == "Y") {
        this.form.hasSuperior = "Y";
      }
    },
