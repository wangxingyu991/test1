  ...
  <div class="drawer-wrap">
    <div class="rh-drawer-body">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="模板代码" prop="messageTemplateCode">
                  <el-input v-model.trim="operatorForm.messageTemplateCode" maxlength="4" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="24">
      ...
      <div class="rh-dialog-footer">
        <el-button type="primary" @click="save()" v-loading="loading">修 改</el-button>
...
export default { 
  ...
  data() {     
    return {
      loading: false, 
      operatorForm: { 
        messageTemplateCode:  this.detailData.messageTemplateCode,
        messageTemplateName:'',
        title:'',
        content:''
      },
  ...
  methods: {
    getMessageTemplateByCode(){
      let _this = this;
      _this.$api.get(
        _this.$apis.manage +  "/rest/manage/messagetemplate/" +  _this.detailData.messageTemplateCode,
        {},
        function (res) {
          if (res.success) {
    ...
    save(){
      ...
      _this.$refs.operatorForm.validate((valid) => {
        if (valid) {
          ...
          _this.loading = true;
          _this.$api.put(this.$apis.manage+"/rest/manage/messagetemplate", para, function (res) {
            _this.loading = false;
            if (res.success == true) {
              _this.$message({
                message: '修改成功',
