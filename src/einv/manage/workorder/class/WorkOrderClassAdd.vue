<template>
  <div class="rh-dialog">
    <div class="rh-dialog-body" >
      <el-form v-loading="loading" v-show="isShow" :model="workOrderUserMainClass" :rules="rules" ref="form" label-width="140px" label-position="right">
        <el-row>
          <el-col :span="11">
        ...
        <el-row>
          <el-col :span="22">
            <div class="rh-dialog-footer">
              <el-button @click="addSubmit('form')">保存</el-button>
      ...
      <el-form v-show="isShow1" v-loading="loading" :model="workOrderUserSmallcls" :rules="rules1" ref="form1" label-width="140px" label-position="right">
        ...
        <el-row>
          <el-col :span="22">
            <div class="rh-dialog-footer">
              <el-button type="primary" @click="addSubmit('form1')">保存</el-button>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules1: {
        ...
        depict: [
          { required: true, message: "请输入工单小类描述", trigger: "blur" },
          { max: 100, message: "最多100个字符", trigger: "blur" },
        ],
        emergencyStatus: [
      ...
      rules: {
        ...
        depict: [
          { required: true, message: "请输入工单大类描述", trigger: "blur" },
          { max: 100, message: "最多100个字符", trigger: "blur" },
        ],
        // sort: [
  ...
  methods: {
    formInit(){
      let _this = this;
      var mainid = this.addPageData.mainClassId;
      if(mainid != ""){
        this.isShow1 = true;
        this.isShow = false;
      }else{
    ...
    addSubmit(formName) {
      ...
      var mainurl = "/manage/workorder/type/addWorkOrderUserMainClass";
      var suburl = "/manage/workorder/type/addWorkOrderUserSmallcls";
      var mainClassId = _this.addPageData.mainClassId;
      ...
      _this.$refs[formName].validate((valid) => {
        ...
        if (valid) {
          ...
          if(mainClassId != ""){
            ...
            _this.$set(addparams, "mainClassId", _this.addPageData.mainClassId);
            _this.$set(addparams, "mainClassName", _this.addPageData.mainClassName);
            _this.$set(addparams, "workOrderUserTypeId", _this.addPageData.workOrderUserTypeId);
