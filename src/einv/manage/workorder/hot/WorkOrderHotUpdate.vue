  ...
  <div class="drawer-wrap">
    <div class="rh-drawer-head">
      ...
      <div class="rh-dialog-footer">
        <el-button type="primary" @click="updateSubmit('tableData')" :loading="loading">修改</el-button>
...
export default {
  ...
  methods: {
    ...
    initPage(){
      // alert(this.updatePageData.workOrderHot.problemName)
      let _this = this;
      // this.editor = new E(this.$refs.toolbar, this.$refs.editor);
      _this.tableData = this.updatePageData.workOrderHot;

      // alert(this.editor.txt.html())

      this.editor.txt.html(this.updatePageData.workOrderHot.problemHandling);
    },
    updateSubmit(form){
      let _this = this;
      ...
      _this.workOrderHot.workOrderHotId = _this.tableData.workOrderHotId;
      _this.workOrderHot.problemName = _this.tableData.problemName;
      _this.workOrderHot.problemHandling = content;
      let urlHot = _this.$apis.manage+"/manage/workorder/hot/updateWorkOrderHot";
