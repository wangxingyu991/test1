      ...
      seteditor() {
        ...
        this.editor.config.customUploadImg = (resultFiles, insertImgFn) => {
          ...
          for (var i = 0; i < resultFiles.length; i++) {
            ...
            _this.$api.post( this.$apis.manage+"/rest/manage/notice/uploadimg", formData,
              function (res) {
                console.log(res);
                if (res.success) {
        ...
        _this.$refs.operatorForm.validate((valid) => {
          if(valid){
            ...
            if(content.trim() == ""){
              ...
              if(_this.noticeinfo.notifyId != null && _this.noticeinfo.notifyId != undefined){
                var params = {
                    notifyId:this.noticeinfo.notifyId,
                    content: content,
                ...
                _this.showLoading = true;
                _this.$api.post(_this.$apis.manage + "/rest/manage/notice/updatenotice", params, function (res) {
                    _this.showLoading = false;
                    if (res.success == true) {
                      _this.$message({
                        message: '修改成功',
                ...
                _this.$api.post(_this.$apis.manage + "/rest/manage/notice/savenotice", params, function (res) {
                    if (res.success == true) {
                      _this.$message({
                        message: '保存成功',
                        type: 'success'
