    ...
    <div class="rh-page-header">
      <div class="rh-head-and-operate">
        <div class="tips-content">
          <span class="rh-helpTip-text"> 续费 </span>
        </div>
      </div>
    </div>
        ...
        <el-table :data="tableData.records" stripe border height="400" v-loading="loading">
          ...
          <el-table-column align="left" label="操作">
            <template slot-scope="scope">
              ...
              <el-button class="table_btn" type="text" @click="renew(scope.row)">续费</el-button>
            </template>
          </el-table-column>
        </el-table>
...
import Renew from "./RenewPage.vue";
...
export default {
  ...
  methods: {
    ...
    init_Table() {
      ...
      _this.loading = true;
      this.$api.post(
        _this.$apis.order + "/order/renew/listRenewableOrders/",
        params,
        function (res) {
          if (res.success) {
