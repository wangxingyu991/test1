              ...
              <el-col :span="8" v-for="(item,index) in value" :key="index" style="padding-left: 0px;">
                <div class="border-dotted">
                  ...
                  <div class="number-item">
                    <el-input-number size="mini" :precision="0" :min="0" :max="9999" v-model="item.num" :disabled="false" @change="setValue"></el-input-number>
                  </div>
                  <div class="unit-item">
...
export default {
  ...
  mounted() {
    this.labelWidth = this.shopNumber.data.labelWidth;
    this.keyName = this.shopNumber.data.keyName;
    this.detail = this.shopNumber.data.detail.replace(/[\r\n]/g, "<br/>");
    this.value = this.shopNumber.data.value;
  },
  methods: {
    setValue() {
      this.shopNumber.data.value = this.value;
