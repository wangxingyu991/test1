<template>
  <div>
    <frame-tree :treeData="treeData" @getnode="getnode">
      <div>
        <!-- 树形结构右侧内容 -->
              ...
              <div class="rh-operate clearfix">
                  ...
                  <div class="rh-pull-right">
                        <el-form :model="search" ref="search" :inline="false" label-width="0px" style="display: flex;justify-content: flex-end;">
                              ...
                              <el-button v-on:click="searchWrap=!searchWrap">
                                    <i class="el-icon-arrow-down" v-show="!searchWrap"></i><i class="el-icon-arrow-up" v-show="searchWrap"></i>
                              </el-button>
...
<script>
import frameTree from './tree/frameTree.vue'
export default {
  components:{frameTree},
  data(){
      return{
            treeData:[{
                  label: '北京市',
