...
export default {
  ...
  mounted() {
    this.labelWidth = this.checkGroupData.labelWidth;
    this.keyName = this.checkGroupData.keyName;
    this.checkboxsVal = this.checkGroupData.checkboxsVal;
    this.label = this.checkGroupData.label;
    this.detail = this.checkGroupData.detail.replace(/[\r\n]/g, "<br/>");
  },
  methods: {
    setCheckbox() {
